...
import { ConfigModulesProducts } from "utils/routes";
...
const ModuleConfigProductsContainer = ({
  openDrawerPrimary,
  routes,
  permissionsModule,
}) => {
    ...
    <div className={classes.root}>
      ...
      >
        <ContentItems style={{ overflowX: "hidden", marginTop: "75px" }}>
          <List>
            {permissionsModule &&
              ConfigModulesProducts.map((menuItem) => (
...
export default connect(mapStateToProps)(ModuleConfigProductsContainer);

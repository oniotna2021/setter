...
import { ConfigRootNameHistoryMedical } from "utils/routes";
    ...
    <div className={classes.root}>
      ...
      >
        ...
        <ContentItems style={{ overflowX: "hidden" }}>
          <List>
            {ConfigRootNameHistoryMedical.map((menuItem) => (
...
export default connect(mapStateToProps)(ModuleTrainingContainer);

...
// Components
import { FormTypeTicket } from "./FormTypeTicket";
...
// Service
import { getPaginateTypeTickets } from "services/Tickets/typeTicket";

const ListTypeTicket = () => {
  ...
  useEffect(() => {
    setFetchData(true);
    getPaginateTypeTickets(currentPage, itemsPerPage)
      .then(({ data }) => {
        setFetchData(false);
        if (
          data &&
    ...
    <div className="container">
      <div className="row gx-3">
        <div className="col">
          <div className="row">
            <div className="col-8">
              <Typography variant="h4">Tipos de Tickets</Typography>
            </div>
              ...
              <div className="row mt-3">
                <div className="col">
                  <CommonComponentAccordion
                    ...
                    title_no_data="Crear nuevo tipo de ticket"
                    form={
                      <FormTypeTicket
                        load={load}
                        setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTypeTicket);

...
// Components
import { FormSeverity } from "./FormSeverity";
...
// Service
import { getPaginateTicketSeverity } from "services/Tickets/severity";
...
export const ListSeverity = () => {
  ...
  useEffect(() => {
    setFetchData(true);
    getPaginateTicketSeverity(currentPage, itemsPerPage)
      .then(({ data }) => {
        setFetchData(false);
        if (
          data &&
    ...
    <div className="container">
      <div className="row gx-3">
        <div className="col">
          <div className="row">
            <div className="col-8">
              <Typography variant="h4">Clasificación</Typography>
            </div>
              ...
              <div className="row mt-3">
                <div className="col">
                  <CommonComponentAccordion
                    ...
                    title_no_data="Crear nueva clasificación"
                    form={
                      <FormSeverity
                        load={load}
                        setLoad={setLoad}
...
export default connect(mapStateToProps)(ListSeverity);

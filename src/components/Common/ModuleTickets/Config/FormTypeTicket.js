...
import {
  ...
  putTypeTicket,
  deleteTypeTicket,
} from "services/Tickets/typeTicket";
...
export const FormTypeTicket = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postTypeTicket : putTypeTicket;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteTypeTicket(defaultValue.uuid)
          .then((req) => {
            Swal.fire(

...
export const ListCompanies = ({ permissionsActions }) => {
  ...
  const getList = useCallback(() => {
    ...
    getAllOrganizations()
      .then(({ data }) => setOrganizationsOptions(data.data))
      .catch((err) => {
        enqueueSnackbar(mapErrors(err), errorToast);
      });
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListCompanies.CreateCompany")}
                        form={
                          <FormCompany
                            setExpanded={setExpanded}
                            getList={getList}

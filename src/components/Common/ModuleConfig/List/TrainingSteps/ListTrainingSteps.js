...
// Components
import { FormTrainingSteps } from "components/Common/ModuleConfig/Manage/TrainingSteps/FormTrainingSteps";
...
import {
  getTrainingSteps,
  orderListTrainingSteps,
} from "services/TrainingPlan/TrainingSteps";

// HOCS
import ActionWithPermission from "hocs/ActionWithPermission";

export const ListTrainingSteps = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTrainingSteps.Container.TitleNoData"
                        )}
                        form={
                          <FormTrainingSteps
                            type="Nuevo"
                ...
                <div className="row mt-3">
                  <div className="col">
                    <SortableList
                      ...
                      expanded={expanded}
                      setExpanded={setExpanded}
                      FormComponent={FormTrainingSteps}
                      type="Editar"
                      load={load}
                      setLoad={setLoad}
                    />
...
export default connect(mapStateToProps)(ListTrainingSteps);

...
import { MovementsForm } from "config/Forms/ConfigForms";
...
export const FormMovements = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postMovements : putMovements;
    ...
    Swal.fire({
      ...
      .then((result) => {
        if (result.isConfirmed) {
          deleteMovement(defaultValue.id)
            .then((req) => {
              Swal.fire(
                "¡Eliminado!",

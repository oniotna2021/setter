...
import { HealthTechnologyForm } from "../../../../../config/Forms/MedicalForms";
...
//Services
import {
  postHealthTechnology,
  putHealthTechnology,
  deleteHealthTechnology,
} from "../../../../../services/MedicalSoftware/HealthTechnology";
...
export const FormHealthTechnology = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postHealthTechnology : putHealthTechnology;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteHealthTechnology(defaultValue.id)
          .then((req) => {
            Swal.fire(

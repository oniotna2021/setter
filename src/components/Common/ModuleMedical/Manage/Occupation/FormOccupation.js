...
import { OccupationForm } from "../../../../../config/Forms/MedicalForms";
...
import {
  ...
  putOccupation,
  deleteOccupation,
} from "../../../../../services/MedicalSoftware/Occupation";
...
export const FormOccupation = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postOccupation : putOccupation;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteOccupation(defaultValue.id)
          .then((req) => {
            Swal.fire(

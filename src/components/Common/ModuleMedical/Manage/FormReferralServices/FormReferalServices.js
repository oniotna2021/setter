...
//Services
import {
  postMasterAutoCompleteSelect,
  putMasterAutoCompleteSelect,
  deleteMasterAutoCompleteSelect,
} from "services/VirtualJourney/GetMasterAutocomplete";
...
export const FormReferalServices = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteMasterAutoCompleteSelect(defaultValue.id)
          .then((req) => {
            Swal.fire(

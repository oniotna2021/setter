...
import { TerritorialEntityForm } from "config/Forms/MedicalForms";
...
//Services
import {
  postTerritorialEntity,
  putTerritorialEntity,
  deleteTerritorialEntity,
} from "services/MedicalSoftware/TerritorialEntity";
...
export const FormTerritorialEntity = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postTerritorialEntity : putTerritorialEntity;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteTerritorialEntity(defaultValue.id)
          .then((req) => {
            Swal.fire(

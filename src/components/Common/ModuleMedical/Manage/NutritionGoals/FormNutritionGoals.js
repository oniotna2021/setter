...
import { NutritionGoalsForm } from "config/Forms/MedicalForms";

//Services
import {
  postNutritionGoal,
  putNutritionalGoal,
  deleteNutritionalGoal,
} from "services/MedicalSoftware/NutritionGoals";
...
export const FormNutritionGoals = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postNutritionGoal : putNutritionalGoal;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteNutritionalGoal(defaultValue.id)
          .then((req) => {
            Swal.fire(

...
import { DisabilityForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putDisability,
  deleteDisability,
} from "services/MedicalSoftware/Disability";
...
export const FormDisability = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postDisability : putDisability;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteDisability(defaultValue.id).then((req) => {
          Swal.fire(

...
import { MusculoskeletalHistoryForm } from "config/Forms/MedicalForms";
...
//Services
import {
  postMusculoskeletalHistory,
  putMusculoskeletalHistory,
  deleteMusculoskeletalHistory,
} from "services/MedicalSoftware/MusculoskeletalHistory";
...
export const FormMusculoskeletalHistory = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postMusculoskeletalHistory : putMusculoskeletalHistory;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteMusculoskeletalHistory(defaultValue.id).then((req) => {
          Swal.fire(
      ...
      <div className="row align-items-end">
        <div className="col">
          <CommonComponentSimpleForm
            form={MusculoskeletalHistoryForm}
            control={control}

...
import { OMSRiskForm } from "../../../../../config/Forms/MedicalForms";
...
import {
  ...
  putOMSRisk,
  deleteOMSRisk,
} from "../../../../../services/MedicalSoftware/OMSRisk";
...
export const FormOMSRisk = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postOMSRisk : putOMSRisk;

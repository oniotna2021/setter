...
import { EthnicityForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putEthnicity,
  deleteEthnicity,
} from "services/MedicalSoftware/Ethnicity";
...
export const FormEthnicity = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postEthnicity : putEthnicity;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteEthnicity(defaultValue.id).then((req) => {
          Swal.fire(

...
import {
  ...
  putLinkTypes,
  deleteLinkTypes,
} from "services/MedicalSoftware/LinkTypes";
...
export const FormLinkTypes = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postLinkTypes : putLinkTypes;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteLinkTypes(defaultValue.id)
          .then((req) => {
            Swal.fire(

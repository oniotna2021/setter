...
import { PathologicalAntecedentsForm } from "config/Forms/MedicalForms";
...
//Services
import {
  postPathologicalAntecedents,
  putPathologicalAntecedents,
  deletePathologicalAntecedents,
} from "services/MedicalSoftware/PathologicalAntecedents";
...
export const FormPathologicalAntecedents = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deletePathologicalAntecedents(defaultValue.id)
          .then((req) => {
            Swal.fire(
      ...
      <div className="row align-items-end">
        <div className="col">
          <CommonComponentSimpleForm
            form={PathologicalAntecedentsForm}
            control={control}

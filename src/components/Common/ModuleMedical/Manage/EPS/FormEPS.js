...
import { EPSForm } from "config/Forms/MedicalForms";
...
//Services
import { deleteEPS, postEPS, putEPS } from "services/MedicalSoftware/EPS";
...
export const FormEPS = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postEPS : putEPS;

...
import { ModalityForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putModality,
  deleteModality,
} from "services/MedicalSoftware/Modality";
...
export const FormModality = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postModality : putModality;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteModality(defaultValue.id)
          .then((req) => {
            Swal.fire(

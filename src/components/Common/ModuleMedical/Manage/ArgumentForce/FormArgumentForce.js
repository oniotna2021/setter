...
import { ArgumentForceForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putArgumentForce,
  deleteArgumentForce,
} from "services/MedicalSoftware/ArgumentForce";
...
export const FormArgumentForce = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postArgumentForce : putArgumentForce;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteArgumentForce(defaultValue.uuid)
          .then((req) => {
            Swal.fire(

...
import { SleepPatternForm } from "../../../../../config/Forms/MedicalForms";
...
import {
  ...
  putSleepPattern,
  deleteSleepPattern,
} from "../../../../../services/MedicalSoftware/SleepPattern";
...
export const FormSleepPattern = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postSleepPattern : putSleepPattern;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteSleepPattern(defaultValue.id)
          .then((req) => {
            Swal.fire(

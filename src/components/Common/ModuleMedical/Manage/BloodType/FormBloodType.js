...
import { BloodTypeForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putBloodType,
  deleteBloodType,
} from "services/MedicalSoftware/BloodType";
...
export const FormBloodType = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postBloodType : putBloodType;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteBloodType(defaultValue.id)
          .then((req) => {
            Swal.fire(

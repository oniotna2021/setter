...
import { DiagnosisForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putDiagnosis,
  deleteDiagnosis,
} from "services/MedicalSoftware/Diagnosis";
...
/*
    FUNCTION: form to manage procedure items
    PROPERTIES: type - string, defaultValue - array, setExpanded - function, load - boolean, setLoad - function
*/
export const FormDiagnosis = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postDiagnosis : putDiagnosis;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteDiagnosis(defaultValue.id)
          .then((req) => {
            Swal.fire(

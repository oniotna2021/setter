...
import { HealthEducationForm } from "../../../../../config/Forms/MedicalForms";
...
} from "../../../../../services/MedicalSoftware/HealthEducation";
...
export const FormHealthEducation = ({
  type,
  defaultValue,
  setExpanded,
  reload,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postHealthEducation : putHealthEducation;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteHealthEducation(defaultValue.id)
          .then((req) => {
            Swal.fire(

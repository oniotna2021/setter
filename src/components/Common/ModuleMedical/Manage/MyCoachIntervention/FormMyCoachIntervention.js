...
import { MyCoachInterventionForm } from "../../../../../config/Forms/MedicalForms";
...
//Services
import {
  postMyCoachIntervention,
  putMyCoachIntervention,
  deleteMyCoachIntervention,
} from "../../../../../services/MedicalSoftware/MyCoachIntervention";
...
export const FormMyCoachIntervention = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postMyCoachIntervention : putMyCoachIntervention;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteMyCoachIntervention(defaultValue.id)
          .then((req) => {
            Swal.fire(

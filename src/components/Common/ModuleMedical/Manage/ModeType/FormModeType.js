...
import { ModeTypeForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putModeType,
  deleteModeType,
} from "services/MedicalSoftware/ModeType";
...
export const FormModeType = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postModeType : putModeType;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteModeType(defaultValue.id)
          .then((req) => {
            Swal.fire(

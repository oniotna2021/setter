...
import { ProcedureForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putProcedure,
  deleteProcedure,
} from "services/MedicalSoftware/Procedure";
...
export const FormProcedure = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postProcedure : putProcedure;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteProcedure(defaultValue.id)
          .then((req) => {
            Swal.fire(

...
import { RelationshipForm } from "config/Forms/MedicalForms";
...
import {
  ...
  putRelationship,
  deleteRelationship,
} from "services/MedicalSoftware/Relationship";
...
export const FormRelationship = ({
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postRelationship : putRelationship;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteRelationship(defaultValue.id)
          .then((req) => {
            Swal.fire(

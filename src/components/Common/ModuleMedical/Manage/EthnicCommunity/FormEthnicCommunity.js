...
import { EthnicCommunityForm } from "config/Forms/MedicalForms";
...
import {
  postEthnicCommunity,
  putEthnicCommunity,
  deleteEthnicCommunity,
} from "services/MedicalSoftware/EthnicCommunity";
...
export const FormEthnicCommunity = ({
  type,
  defaultValue,
  setExpanded,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postEthnicCommunity : putEthnicCommunity;
  ...
  const deleteForm = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteEthnicCommunity(defaultValue.id)
          .then((req) => {
            Swal.fire(

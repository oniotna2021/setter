...
// Components
import { FormOccupation } from "../../Manage/Occupation/FormOccupation";
...
export const ListOccupation = ({ permissionsActions }) => {
          ...
          <div className="row">
            <div className="col-8">
              <Typography variant="h4">
                {t("ListOccupation.TitleOcupation")}
              </Typography>
            </div>
                ...
                <div className="col">
                  <ActionWithPermission isValid={permissionsActions.create}>
                    <CommonComponentAccordion
                      ...
                      title_no_data={t("ListOccupation.CreateNewOcupation")}
                      form={
                        <FormOccupation
                          type="Nuevo"
                          setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListOccupation);

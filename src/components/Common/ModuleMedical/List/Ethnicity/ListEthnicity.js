...
// Components
import { FormEthnicity } from "components/Common/ModuleMedical/Manage/Ethnicity/FormEthnicity";
...
export const ListEthnicity = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListEthnicity.TitleEthnicity")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListEthnicity.CreateNewEthnicity")}
                        form={
                          <FormEthnicity
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListEthnicity);

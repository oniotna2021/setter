...
// Components
import { FormHealthEducation } from "../../Manage/HealthEducation/FormHealthEducation";
...
export const ListHealthEducation = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListHealthEducation.CreateNewHealthEducation"
                        )}
                        form={
                          <FormHealthEducation
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListHealthEducation);

...
// Components
import { FormWeightUnit } from "../../Manage/WeightUnit/FormWeightUnit";
...
export const ListWeightUnit = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListWeightUnit.TitleWeightUnit")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListWeightUnit.CreateNewWeightUnit")}
                        form={
                          <FormWeightUnit
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListWeightUnit);

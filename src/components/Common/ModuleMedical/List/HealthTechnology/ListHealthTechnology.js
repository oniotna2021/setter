...
// Components
import { FormHealthTechnology } from "../../Manage/HealthTechnology/FormHealthTechnology";
...
export const ListHealthTechnology = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListHealthTechnology.TitleHealthTechnology")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListHealthTechnology.CreateNewHealthTechnology"
                        )}
                        form={
                          <FormHealthTechnology
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListHealthTechnology);

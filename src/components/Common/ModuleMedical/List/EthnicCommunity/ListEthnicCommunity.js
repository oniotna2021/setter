...
// Components
import { FormEthnicCommunity } from "components/Common/ModuleMedical/Manage/EthnicCommunity/FormEthnicCommunity";
...
export const ListEthnicCommunity = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListEthnicCommunity.CreateNewEthnicCommunity"
                        )}
                        form={
                          <FormEthnicCommunity
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListEthnicCommunity);

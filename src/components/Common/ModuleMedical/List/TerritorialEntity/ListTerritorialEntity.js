...
// Components
import { FormTerritorialEntity } from "components/Common/ModuleMedical/Manage/TerritorialEntity/FormTerritorialEntity";
...
export const ListTerritorialEntity = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTerritorialEntity.CreateNewTerritorialEntity"
                        )}
                        form={
                          <FormTerritorialEntity
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTerritorialEntity);

...
// Components
import { FormTypeFood } from "components/Common/ModuleMedical/Manage/TypeFood/FormTypeFood";
                  ...
                  <ActionWithPermission isValid={permissionsActions.create}>
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListTypeFood.CreateNewTypeFood")}
                        form={
                          <FormTypeFood
                            type="Nuevo"
                            setExpanded={setExpanded}

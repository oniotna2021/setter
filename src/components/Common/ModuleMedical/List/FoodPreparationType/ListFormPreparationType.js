...
// Components
import { FormFoodPreparationType } from "../../Manage/FoodPreparationType/FormFoodPreparationType";
...
export const ListFoodPreparationType = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListFormPreparationType.TitlePreparationType")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListFormPreparationType.CreateNewPreparationType"
                        )}
                        form={
                          <FormFoodPreparationType
                            type="Nuevo"
                            setExpanded={setExpanded}
                            reload={reload}
                            setReload={setReload}
...
export default connect(mapStateToProps)(ListFoodPreparationType);

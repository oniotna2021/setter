...
// Components
import { FormTerritorialZones } from "components/Common/ModuleMedical/Manage/TerritorialZones/FormTerritorialZones";
...
export const ListTerritorialZones = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListTerritorialZones.TitleTerritorialZones")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTerritorialZones.CreateNewTerritorialZones"
                        )}
                        form={
                          <FormTerritorialZones
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTerritorialZones);

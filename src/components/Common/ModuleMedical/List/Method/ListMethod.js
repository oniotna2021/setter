...
// Components
import { FormMethod } from "components/Common/ModuleMedical/Manage/Method/FormMethod";
...
export const ListMethod = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListMethod.CreateNewMethod")}
                        form={
                          <FormMethod
                            type="Nuevo"
                            setExpanded={setExpanded}

...
// Components
import { FormPathologicalAntecedents } from "components/Common/ModuleMedical/Manage/PathologicalAntecedents/FormPathologicalAntecedents";
...
export const ListPathologicalAntecedents = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t(
                    "ListPathologicalAntecedents.TitlePathologicalAntecedents"
                  )}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListPathologicalAntecedents.CreateNewPathologicalAntecedents"
                        )}
                        form={
                          <FormPathologicalAntecedents
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListPathologicalAntecedents);

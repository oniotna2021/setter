...
// Components
import { FormServiceGroup } from "components/Common/ModuleMedical/Manage/ServiceGroup/FormServiceGroup";
...
// Service
import { getServiceGroup } from "services/MedicalSoftware/ServiceGroup";

export const ListServiceGroup = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListServiceGroup.TitleServiceGroup")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListServiceGroup.CreateNewServiceGroup"
                        )}
                        form={
                          <FormServiceGroup
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListServiceGroup);

...
// Components
import { FormPhysicalActivity } from "../../Manage/PhysicalActivity/FormPhysicalActivity";
...
// Service
import { getPhysicalActivity } from "../../../../../services/MedicalSoftware/PhysicalActivity";

export const ListPhysicalActivity = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListPhysicalActiviy.TitlePhysicalActiviy")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListPhysicalActiviy.CreateNewPhysicalActiviy"
                        )}
                        form={
                          <FormPhysicalActivity
                            type="Nuevo"
                            setExpanded={setExpanded}
                            reload={reload}
                            setReload={setReload}
...
export default connect(mapStateToProps)(ListPhysicalActivity);

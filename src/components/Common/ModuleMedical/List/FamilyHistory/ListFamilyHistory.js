...
// Components
import { FormFamilyHistory } from "components/Common/ModuleMedical/Manage/FamilyHistory/FormFamilyHistory";
...
export const ListFamilyHistory = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListFamilyHistory.TitleFamilyHistory")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListFamilyHistory.CreateNewFamilyHistory"
                        )}
                        form={
                          <FormFamilyHistory
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListFamilyHistory);

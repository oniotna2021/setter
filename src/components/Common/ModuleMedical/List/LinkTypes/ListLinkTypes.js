...
// Components
import { FormLinkTypes } from "components/Common/ModuleMedical/Manage/LinkTypes/FormLinkTypes";
...
export const ListLinkTypes = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListLinkTypes.TitleLinkTypes")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListLinkTypes.CreateNewLinkTypes")}
                        form={
                          <FormLinkTypes
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListLinkTypes);

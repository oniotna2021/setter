...
// Components
import { FormDiagnosis } from "../../Manage/Diagnosis/FormDiagnosis";
...
export const ListDiagnosis = ({ permissionsActions }) => {
          ...
          <div className="row">
            <div className="col-8">
              <Typography variant="h4">
                {t("ListDiagnosis.TitleDiagnosis")}
              </Typography>
            </div>
                ...
                <div className="col">
                  <ActionWithPermission isValid={permissionsActions.create}>
                    <CommonComponentAccordion
                      ...
                      title_no_data={t("ListDiagnosis.CreateNewDiagnosis")}
                      form={
                        <FormDiagnosis
                          type="Nuevo"
                          setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListDiagnosis);

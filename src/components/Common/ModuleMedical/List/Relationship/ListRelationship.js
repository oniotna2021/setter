...
// Components
import { FormRelationship } from "../../Manage/Relationship/FormRelationship";
...
export const ListRelationship = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListRelationship.TitleRelationship")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListRelationship.CreateNewRelationship"
                        )}
                        form={
                          <FormRelationship
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListRelationship);

...
// Components
import { FormTypeAlimentation } from "components/Common/ModuleMedical/Manage/TypeAlimentation/FormTypeAlimentation";
...
/*
    FUNCTION: list all type alimentation
    PROPERTIES: ---
*/
export const ListTypeAlimentation = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListTypeAlimentation.TypeAlimentation")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTypeAlimentation.NewTypeAlimentation"
                        )}
                        form={
                          <FormTypeAlimentation
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTypeAlimentation);

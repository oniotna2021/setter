...
// Components
import { FormCauseAttention } from "components/Common/ModuleMedical/Manage/CauseAttention/FormCauseAttention";
...
// Service
import { getCauseAttention } from "services/MedicalSoftware/CauseAttention";

export const ListCauseAttention = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListCauseAttention.CauseAttention")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListCauseAttention.CreateNewCause")}
                        form={
                          <FormCauseAttention
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListCauseAttention);

...
// Components
import { FormQueryType } from "components/Common/ModuleMedical/Manage/QueryType/FormQueryType";
...
// Service
import { getQueryType } from "services/MedicalSoftware/QueryType";

export const ListQueryType = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListQueryType.TitleQueryType")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListQueryType.CreateNewQueryType")}
                        form={
                          <FormQueryType
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListQueryType);

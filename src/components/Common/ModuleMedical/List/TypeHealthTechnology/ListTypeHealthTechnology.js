...
// Components
import { FormTypeHealthTechnology } from "../../Manage/TypeHealthTechnology/FormTypeHealthTechnology";
...
export const ListTypeHealthTechnology = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListTypeHealthTechnology.TitleHealthTechnology")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTypeHealthTechnology.CreateNewHealthTechnology"
                        )}
                        form={
                          <FormTypeHealthTechnology
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTypeHealthTechnology);

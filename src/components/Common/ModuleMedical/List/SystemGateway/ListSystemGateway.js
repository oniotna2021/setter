...
// Components
import { FormSystemGateway } from "components/Common/ModuleMedical/Manage/SystemGateway/FormSystemGateway";
...
// Service
import { getSystemGateway } from "services/MedicalSoftware/SystemGateway";

export const ListSystemGateway = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListSystemGateway.TitleSystemGateway")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListSystemGateway.CreateNewSystemGateway"
                        )}
                        form={
                          <FormSystemGateway
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListSystemGateway);

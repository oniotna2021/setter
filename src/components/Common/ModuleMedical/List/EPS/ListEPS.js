...
// Components
import { FormEPS } from "../../Manage/EPS/FormEPS";
...
export const ListEPS = ({ permissionsActions }) => {
    ...
    <div className="container">
      <div className="row gx-3">
        <div className="col">
          <div className="row">
            <div className="col-8">
              <Typography variant="h4">{t("ListEPS.TitleEPS")}</Typography>
            </div>
...
export default connect(mapStateToProps)(ListEPS);

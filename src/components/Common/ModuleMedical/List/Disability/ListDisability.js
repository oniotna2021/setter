...
// Components
import { FormDisability } from "components/Common/ModuleMedical/Manage/Disability/FormDisability";
...
export const ListDisability = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListDisability.TitleDisability")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListDisability.CreateNewDisability")}
                        form={
                          <FormDisability
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListDisability);

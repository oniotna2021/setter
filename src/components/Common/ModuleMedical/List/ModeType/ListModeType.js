...
// Components
import { FormModeType } from "components/Common/ModuleMedical/Manage/ModeType/FormModeType";
...
export const ListModeType = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListModeType.CreateNewModeType")}
                        form={
                          <FormModeType
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListModeType);

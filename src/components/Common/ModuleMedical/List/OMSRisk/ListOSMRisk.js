...
// Components
import { FormOMSRisk } from "../../Manage/OMSRisk/FormOMSRisk";
...
// Service
import { getOMSRisk } from "../../../../../services/MedicalSoftware/OMSRisk";

export const ListOMSRisk = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListOSMRisk.NewCreateOSMRisk")}
                        form={
                          <FormOMSRisk
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListOMSRisk);

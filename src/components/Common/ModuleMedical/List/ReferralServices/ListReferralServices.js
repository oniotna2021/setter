...
// Components
import { FormReferalServices } from "components/Common/ModuleMedical/Manage/FormReferralServices/FormReferalServices";
...
export const ListReferralServices = ({ permissionsActions }) => {
  ...
  useEffect(() => {
    setFetchData(true);
    getMasterAutoCompleteSelect(53)
      .then(({ data }) => {
        setFetchData(false);
        if (
          data &&
      ...
      {fecthData ? (
        ...
        <div className="row gx-3">
          <div className="col">
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">{"Servicios de remisión"}</Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={"Crear nuevo servicio de remisión"}
                        form={
                          <FormReferalServices
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListReferralServices);

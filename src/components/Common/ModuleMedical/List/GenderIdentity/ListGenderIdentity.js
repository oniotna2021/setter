...
// Components
import { FormGenderIdentity } from "components/Common/ModuleMedical/Manage/GenderIdentity/FormGenderIdentity";
...
export const ListGenderIdentity = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListGenderIdentity.CreateNewGenderIdentity"
                        )}
                        form={
                          <FormGenderIdentity
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListGenderIdentity);

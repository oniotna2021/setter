...
// Components
import { FormCurrency } from "components/Common/ModuleConfigProducts/Currencies/FormCurrency";
...
export const ListCurrencies = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListCurrencies.CreateNewCurrency")}
                        form={
                          <FormCurrency
                            type="Nuevo"
                            setExpanded={setExpanded}

...
// Components
import { FormChannel } from "components/Common/ModuleConfigProducts/Channels/FormChannel";
...
export const ListChannels = ({ permissionsActions }) => {
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListChannels.CreateNewChannel")}
                        form={
                          <FormChannel
                            type="Nuevo"
                            setExpanded={setExpanded}

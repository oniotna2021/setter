...
// services
import { getAllObjetive } from "services/JourneyModule/ObjetivesJurney";
...
import FormListObjetiveVirtualProducts from "./FormListObjetiveVirtualProducts";

export const ListObjetiveVirtualProduct = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListObjetiveVirtualProduct.title")}
                </Typography>
              </div>
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListObjetiveVirtualProduct.description"
                        )}
                        form={
                          <FormListObjetiveVirtualProducts
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListObjetiveVirtualProduct);

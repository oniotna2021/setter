...
import {
  ...
  putObjetives,
  deleteObjetives,
} from "services/JourneyModule/ObjetivesJurney";

// utils
import { successToast, errorToast, mapErrors } from "utils/misc";

const FormListObjetiveVirtualProducts = ({
  permissionsActions,
  defaultValue,
  setLoad,
  load,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall = type === "Nuevo" ? postObjetive : putObjetives;
    ...
    Swal.fire({
      ...
      .then((result) => {
        if (result.isConfirmed) {
          deleteObjetives(defaultValue.id)
            .then((req) => {
              Swal.fire(
                "¡Eliminado!",
...
export default FormListObjetiveVirtualProducts;

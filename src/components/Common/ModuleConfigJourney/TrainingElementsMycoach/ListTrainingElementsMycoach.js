...
// service
import { getAllTrainingElements } from "services/JourneyModule/TrainingElementsMycoach";
...
import FormTrainingElementsMycoach from "./FormTrainingElementsMycoach";

export const ListTrainingElementsMycoach = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListTrainingElementsMycoach.title")}
                </Typography>
              </div>
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListTrainingElementsMycoach.description"
                        )}
                        form={
                          <FormTrainingElementsMycoach
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default connect(mapStateToProps)(ListTrainingElementsMycoach);

...
// service
import { getAllTypeTask } from "services/JourneyModule/TaskJourney";
...
export const ListTypeTask = ({ permissionsActions }) => {
      ...
      {fecthData ? (
        ...
        <div className="row gx-3">
          <div className="col">
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">{t("ListTypeTask.title")}</Typography>
              </div>
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListTypeTask.description")}
                        form={
                          <FormTypeTask
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListTypeTask);

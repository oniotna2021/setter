...
// service
import { getAllCardiacDiseases } from "services/JourneyModule/HeartDiseases";
...
import FormHeartDiseases from "./FormHeartDiseases";

export const ListHeartDiseases = ({ permissionsActions }) => {
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListHeartDiseases.description")}
                        form={
                          <FormHeartDiseases
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListHeartDiseases);

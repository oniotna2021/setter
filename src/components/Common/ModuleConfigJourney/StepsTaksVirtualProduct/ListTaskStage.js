...
// service
import { getAllTaskSteps } from "services/JourneyModule/TaskJourney";
...
import FormTaskStage from "./FormTaskStage";

export const ListTaskStage = ({ permissionsActions }) => {
      ...
      {fecthData ? (
        ...
        <div className="row gx-3">
          <div className="col">
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">{t("ListTaskStage.title")}</Typography>
              </div>
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t("ListTaskStage.description")}
                        form={
                          <FormTaskStage
                            type="Nuevo"
                            setExpanded={setExpanded}
...
export default connect(mapStateToProps)(ListTaskStage);

...
import FormReasonsReasingQuotes from "./FormReasonsReasingQuotes";
...
// service
import { getReasonsPagination } from "services/JourneyModule/ReasonsReasingQuotes";
...
export const ListReasonsReasingQuotes = ({ permissionsActions }) => {
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListReasonsReasingQuotes.title")}
                </Typography>
              </div>
                  ...
                  <div className="row mt-3">
                    <div className="col">
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListReasonsReasingQuotes.description"
                        )}
                        form={
                          <FormReasonsReasingQuotes
                            isEdit={false}
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
...
export default ListReasonsReasingQuotes;

...
// Components
import { FormReasonBlock } from "components/Common/ModuleConfigReservations/ReasonBlock/FormReasonBlock";
...
// Service
import { getAllReasons } from "services/Reservations/reasonBlock";
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListReasonBlock.CreateNewReasonBlock"
                        )}
                        form={
                          <FormReasonBlock
                            type="Nuevo"
...
export default connect(mapStateToProps)(ListReasonBlock);

...
} from "services/Reservations/locationCategory";
...
export const FormLocationCategory = ({
  type,
  idItem,
  defaultValue,
  setExpanded,
  ...
  const onSubmit = (value) => {
    ...
    const functionCall =
      type === "Nuevo" ? postLocationCategory : putLocationCategory;

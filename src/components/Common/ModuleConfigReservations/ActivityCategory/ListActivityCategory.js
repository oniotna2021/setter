...
// Components
import { FormActivityCategory } from "components/Common/ModuleConfigReservations/ActivityCategory/FormActivityCategory";
            ...
            <div className="row">
              <div className="col-8">
                <Typography variant="h4">
                  {t("ListActivityCategory.Container")}
                </Typography>
              </div>
                  ...
                  <div className="col">
                    <ActionWithPermission isValid={permissionsActions.create}>
                      <CommonComponentAccordion
                        ...
                        title_no_data={t(
                          "ListActivityCategory.CreateNewActivity"
                        )}
                        form={
                          <FormActivityCategory
                            type="Nuevo"
                            setExpanded={setExpanded}
                            load={load}
                            setLoad={setLoad}
